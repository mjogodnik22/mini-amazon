...
CREATE VIEW ProductSummary(name, description, category, price, review, rating, image) AS
SELECT Products.name, Products.description, Products.category, Products.price, 
ProductReview.review,ProductReview.rating, Products.picture
FROM Products, ProductReview
WHERE Products.pid = ProductReview.product_id
